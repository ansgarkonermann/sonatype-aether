...
/**
 * A parser for an artifact description in an INI-like format. <p> Possible sections are: <ul> <li>relocations</li>
 * <li>dependencies</li> <li>managedDependencies</li> <li>repositories</li> </ul> The relocation- and dependency-sections contain
 * artifact coordinates of the form:
 *
 * <pre>
